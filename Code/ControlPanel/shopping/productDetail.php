...
if(isset($_POST["btnSubmit"])){
    ...
    //FILE 1
    $fileDownloadTarget =  $GLOBALS["ROOT"]."/_content_files/product/";
    ...
    $uploadFileTarget =  $GLOBALS["ROOT"]."/_content_images/product/";
    ...
    $uploadFileTarget2 =  $GLOBALS["ROOT"]."/_content_images/product/image2";
    ...
    $uploadFileTarget3 =  $GLOBALS["ROOT"]."/_content_images/product/image3";
    ...
    $uploadFileTarget4 =  $GLOBALS["ROOT"]."/_content_images/product/image4";
    ...
    {
        $prdCode = GenerateNextID("shopping","ProductCode",5,"P");
        $sqlInsert = "insert into shopping (ProductCode,ProductName,ShortDescription,ShortDescription2,ProductDetail,ProductDetail2,ProductDetail3,ProductDetail4,ProductDetail5,ProductDetail6,Image,Image2,Image3,Image4,Video,Video2
                        ...
                        ,TaxInfo,Vendor,Collection,Barcode,ColorCode,ColorCode2)
                    VALUES(
                        '$prdCode',
                        '$txtSubject',
                        '$txtShortDescription',
...
if(!empty($prdCode)){
    $sqlPrd = "select * from shopping where ProductCode = '$prdCode'";
...
<style>
    ...
    .product-promotion-container{display:block}
    .product-new-container{display:block}
    .product-recommend-container{display:none}
    .product-bestseller-container{display:block}
    .product-material-container{display:block}
    .product-file-container{display:none}
    .product-location-container{display:none}
    .product-tag-container{display:none}
    .product-size-container{display:block}
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <select name="ddlCategory" onchange="loadSubCategory(this.value);"   class="form-control input-sm require" >
                        ...
                        <div class="alert alert-warning hide">
                            ...
                            <span class="text-primary hide"><b>ข้อมูลโครงการ</b></span>
                            <hr style="margin-top: 5px;" />
                            <div class="row hide">
                                <div class="col-sm-6">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-sm-4 hide">
                                    ...
                                    <div class="input-group">
                                        <input name="txtStartDate" type="text" placeholder="วันที่สิ้นสุด..." class="form-control date-picker require" autocomplete="off"
                            ...
                            <span class="text-primary hide"><b>ข้อมูลเพิ่มเติม</b></span>
                            <hr class="hide" style="margin-top: 5px;" />
                            <div class="row hide">
                                <div class="col-sm-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="product-active-container">
                            ...
                            <div class="product-promotion-container hide">
                                <br />
                                <span><b>สินค้าโปรโมชั่น</b></span>
                            ...
                            <div class="product-bestseller-container hide">
                                <br />

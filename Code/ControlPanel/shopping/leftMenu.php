...
<div>
    ...
    <a class="left-group" data-det-group="SHOPPING" href="product.php"><?php echo $_COG_ITEM_NAME ?> <i class="fa fa-caret-right pull-right"></i></a>
    <a class="left-group" data-det-group="CATEGORY" href="productCategory.php">หมวดหมู่ <i class="fa fa-caret-right pull-right"></i></a>
    <a class="left-group" data-det-group="SUBCATEGORY" href="productSubCategory.php">หมวดหมู่ย่อยที่ 2 <i class="fa fa-caret-right pull-right"></i></a>
    ...
    <a class="left-group" data-det-group="BRAND" href="productBrand.php">ยี่ห้อ <i class="fa fa-caret-right pull-right"></i></a>
    ...
    <?php if($__COGS_GLOBAL_CART){ ?>
        ...
        <a class="left-group" data-det-group="SIZE" href="productSize.php">ไซส์ <i class="fa fa-caret-right pull-right"></i></a>
    <?php } ?>
    <a class="left-group" data-det-group="MATERIAL" href="productMaterial.php">Source <i class="fa fa-caret-right pull-right"></i></a>
    ...
    <a class="left-group hide" data-det-group="MASTERDETAIL" href="masterDetail.php">รายละเอียดทั่วไป<i class="fa fa-caret-right pull-right"></i></a>

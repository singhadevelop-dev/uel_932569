...
if(isset($_POST["btnSave"])){
    ...
    $uploadFileTarget =  $GLOBALS["ROOT"]."/_content_images/product_category/";
    ...
    if(empty($_GET["ref"])){
        ...
        $sql = "insert into product_category (CategoryCode,CategoryName,CategoryDetail,Ready2Wear,Accessories,Active,CreatedOn,CreatedBy,CategorySubName,Image,ImageIcon,CategoryGroup)values(
                '$genID'
                ,'$txtSubject'
                ,'$txtDetail'
                ,$chkReady2Wear
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 <?php echo $IsCatImg ? "" : "hide" ?>">
                        <div>
                            ...
                            <p>
                                <small class="text-danger">*ขนาดภาพที่เหมาะสมที่สุดคือ 1180 x 387 pixels</small>
                            </p>

                            <img id="imge-preview" src="<?php echo empty($data["Image"]) ? "../assets/images/default/1180x387.png" : $data["Image"] ?>" 

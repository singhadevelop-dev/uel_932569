...
<div class="mat-box" style="border-radius: 0 0 3px 3px">
    <div class="row">
        <div class="col-md-2">
            <?php 
            $_LEFT_MENU_ACTIVE = "PROPERTIES";
            include "leftMenu.php"; 
            ?>
        </div>
        <div class="col-md-10">
            <div>
                <a href="productPropertiesDetail.php" class="pull-right">
            ...
            <table 
                ...
                <tbody>
                    ...
                    <tr data-sortable-row-key="<?php echo $data["PropCode"] ?>">
                        ...
                        <td class="text-center sortable-hide-item">
                            <a href="productPropertiesDetail.php?ref=<?php echo $data["PropCode"] ?>">
                                <i class="fa fa-cog"></i>
                            </a>
                            <form method="post" style="display:inline">
                                <button type="submit" class="btn-link" 
                                    onclick="return Confirm(this,'ต้องการลบรายการนี้หรือไม่ ?');"
                                    value="<?php echo $data["PropCode"] ?>" name="btnDeleteRow">

...
<?php 
$_COG_REF_CODE = !empty($_GET['ref']) ? $_GET['ref'] : "SOCIAL";
...
if(isset($_POST["btnUpload"])){
    ...
    $sqlMax = "select MAX(SEQ) as xMax from gallery where RefCode = '$_COG_REF_CODE'";
    ...
    <div class="row" style="margin-bottom: 0;">
        <div class="col-sm-9">
            <h3 style="margin: 0;"><i class="fa fa-home fa-fw"></i>
                <span class="analysis-left-menu-desc">Social</span></h3>
        </div>
...
<div class="mat-box grey-bar">
    <a href="<?php echo $GLOBALS["ROOT"] ?>/ControlPanel/social/social.php" class="link-history-btn">หน้าหลัก Social</a>
    /
    <span class="link-history-btn">ตั้งค่า Social</span>
</div>
    ...
    <div class="row">
        <div class="col-md-3">
            <?php 
                ...
                include $GLOBALS['DOCUMENT_ROOT']."/ControlPanel/social/leftMenu.php"; 
                ?>
        </div>
        <div class="col-md-9">
            <div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-lg-12">
                                                            <div>
                                                                ...
                                                                <p class="hide">
                                                                    <label>รายละเอียดเพิ่มเติม 1</label>
                                                                ...
                                                                <p class="hide">
                                                                    <label>รายละเอียดเพิ่มเติม 3</label>
                        ...
                        <div class="panel-footer">
                            ...
                            <b class="text-danger">
                                <small>*ขนาดภาพที่เหมาะสมที่สุดคือ 1920 x 300 pixels</small>
                            </b>
                        </div>

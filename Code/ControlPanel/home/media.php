...
if(isset($_POST["btnUpload"])){
    ...
    $uploadFileTarget = $GLOBALS["ROOT"]."/ControlPanel/assets/images/media/";
    ...
    $sqlInsert = "insert into gallery (ImageCode,ImageName,RefCode,ImagePath,Active,CreatedOn,CreatedBy)
    VALUES(
        '$imageCode',
        '$imageName',
        'MEDIA_LIST',
...
<div class="mat-box grey-bar">
    ...
    /
    <span class="link-history-btn">ตั้งค่ารายการ Media (หน้าแรก)</span>
...
<div class="mat-box" style="border-radius: 0 0 3px 3px">
    ...
    <div class="row">
        <div class="col-md-3">
            <?php 
                $_LEFT_MENU_ACTIVE = "MEDIA_LIST";
                include $GLOBALS['DOCUMENT_ROOT']."/ControlPanel/home/leftMenu.php"; 
                ?>
        </div>
        <div class="col-md-9">
            <div>
                <span><b>รายการ Media (หน้าแรก)</b></span>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            $sql = "select * from gallery where RefCode = 'MEDIA_LIST' order by ImageCode";
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-sm-4 col-lg-3">
                                                            ...
                                                            style="width: 100%; height: 150px;margin-bottom:5px; background-image: url(<?php echo $data["ImagePath"] ?>), url('https://ipsumimage.appspot.com/634x833,eee')">
                                                                </div>
                            ...
                            <div class="col-sm-4 col-lg-3 hide">
                                <form method="post" enctype="multipart/form-data">
                                    <div class="slide-banner image-box slide-adder hand" onclick="$(this).next().click();" style="position: relative; background-image: url('https://ipsumimage.appspot.com/634x833,eee');">
                        ...
                        <div class="panel-footer">
                            <b class="text-danger">
                                <small>*ขนาดภาพที่เหมาะสมที่สุดคือ 634 x 833 pixels</small>
                            </b>
                        </div>
                    </div>
                    <script>

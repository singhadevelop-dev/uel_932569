...
$_CUSTOM_CONTENT = "PLAN";
$_CUSTOM_CONTENT_NAME = "แบบแปลน";
$_CUSTOM_CONTENT_IMAGE_WIDTH = 1920;
$_CUSTOM_CONTENT_IMAGE_HEIGHT = 2060;


$uploadFileTarget =  $GLOBALS["ROOT"]."/_content_images/".strtolower($_CUSTOM_CONTENT)."/";
...
if (isset($_POST["btnUpload"])) {
    ...
    $sqlMax = "select MAX(SEQ) as xMax from gallery where RefCode = '$_CUSTOM_CONTENT'";
    $dataMax = SelectRow($sqlMax);
    $num = empty($dataMax["xMax"]) ? 0 : intval($dataMax["xMax"]);
    $num++;
    $imageCode = GenerateNextID("gallery", "ImageCode", 10, "G");
    $sqlInsert = "insert into gallery (SEQ,ImageCode,RefCode,ImagePath,Active,CreatedOn,CreatedBy,ImageName,ImageDetail)
    VALUES(
        '$num',
        '$imageCode',
        '$_CUSTOM_CONTENT',
...
if (isset($_POST["btnSaveHTML"])) {
    $txtDetail = GeneratePageFile($_POST["txtDetail"],$_CUSTOM_CONTENT);
}
...
<div class="mat-box grey-bar">
    ...
    /
    <span class="link-history-btn">ตั้งค่า<?php echo $_CUSTOM_CONTENT_NAME ?></span>
...
<div class="mat-box" style="border-radius: 0 0 3px 3px">
    ...
    <div class="row">
        <div class="col-md-3">
            <?php
            $_LEFT_MENU_ACTIVE = "$_CUSTOM_CONTENT";
            include $GLOBALS['DOCUMENT_ROOT'] . "/ControlPanel/home/leftMenu.php";
            ?>
        </div>
        <div class="col-md-9">
            <div>
                <span><b><?php echo $_CUSTOM_CONTENT_NAME ?></b></span>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" id="sortable">
                            ...
                            $sql = "select * from gallery where RefCode = '$_CUSTOM_CONTENT' order by SEQ";
                            ...
                            ?>
                                <div class="col-sm-4 col-lg-3 ui-state-item" data-image-code="<?php echo $data["ImageCode"] ?>">
                                    ...
                                    <div class="text-center" style="margin-bottom:20px">
                                        <b><?php echo empty($data["ImageDetail"]) ? "<i class='text-danger'>ไม่ได้ระบุรายละเอียด</i>" : $data["ImageName"]." - ".$data["ImageDetail"] ?></b>
                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-sm-4 col-lg-3">
                                                                <p>
                                                                    <div id="imge-preview-<?php echo $data["ImageCode"] ?>" class="image-box hand" onclick="$(this).next().click();" style="width: 100%; height: 250px;margin-bottom:5px; background-image: url(<?php echo $data["ImagePath"] ?>)">
                                                                    </div>




                                                                    <input class="hide" type="file" onchange="$(this).validateUploadImage($('#imge-preview-<?php echo $data["ImageCode"] ?>'));" name="fileUploadChange" accept="image/*" />
                            ...
                            <div class="col-sm-4 col-lg-3">
                                <form method="post" enctype="multipart/form-data">
                                    <div class="slide-banner image-box slide-adder hand" onclick="$(this).next().click();" style="position: relative; background-image: url('https://ipsumimage.appspot.com/<?php echo $_CUSTOM_CONTENT_IMAGE_WIDTH ?>x<?php echo $_CUSTOM_CONTENT_IMAGE_HEIGHT ?>,eee');">
                                    ...
                                    <input class="hide" type="file" onchange="uploadBanner(this);" name="fileUpload" id="fileUpload" accept="image/*" />
                    ...
                    <div class="panel-footer">
                            ...
                            <b class="text-danger">
                                <small>*ขนาดภาพที่เหมาะสมที่สุดคือ <?php echo $_CUSTOM_CONTENT_IMAGE_WIDTH ?> x <?php echo $_CUSTOM_CONTENT_IMAGE_HEIGHT ?> pixels</small>
                            </b>
                        </div>
                    <script>
                ...
                <form method="post" class="panel panel-default">
                    <div class="panel-heading">
                        <button name="btnSaveHTML" class="btn btn-success pull-right" style="margin-top:-7px;margin-right:-12px;" type="submit">
                            <i class="fa fa-save fa-fw"></i>
                            บันทึกการเปลี่ยนแปลง
                        </button>
                        <b>การบรรยายเนื้อหา</b>
                    </div>
                    <div class="panel-body" style="padding:0">
                        <style>
                        #AGHtmlEditor-txtDetail{
                        ...
                        <div class="">
                            <div class=" summernote-container">
                                ...
                                $_HTML_EDITOR_CONTENT_ID = $_CUSTOM_CONTENT;

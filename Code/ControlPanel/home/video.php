...
$_COG_REF_CODE = !empty($_GET['ref']) ? $_GET['ref'] : "VIDEO";
...
if(isset($_POST["btnDeleteVideoYoutube"])){
    $sqlDelete = "update gallery set ImagePath2='' where ImageCode = '".$_POST["btnDeleteVideoYoutube"]."'";
    ExecuteSQL($sqlDelete);
}
...
if(isset($_POST["btnUpdateDetail"])){
    ...
    {
        $imageCode = GenerateNextID("gallery","ImageCode",10,"G");
        $sqlInsert = "insert into gallery (ImageCode,RefCode,ImagePath,ImagePath2,ImageName,ImageDetail,Active,CreatedOn,CreatedBy)
        VALUES(
            '$imageCode',
            '$_COG_REF_CODE',
            '',
...
<div class="mat-box grey-bar">
    ...
    /
    <span class="link-history-btn">ตั้งค่าบรรยากาศสนามแข่ง</span>
                                    ...
                                    <div>
                                        ...
                                        <div class="row panel-video">
                                            ...
                                            <div class="panel-video-display col-xs-12 <?php echo !empty($data["ImagePath2"]) ? "" : "hide" ?>">
                                                <div class="slide-banner image-box">
                                                <iframe class="iframe-video-diaplay" style="width:100%;height:100%;background:#000" src="<?php echo $data["ImagePath2"] ?>"></iframe>
                                            ...
                                            <div class="col-sm-6">
                                                <p>
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" placeholder="URL Youtube" class="form-control input-sm require" name="txtImagePathVideo" value="<?php echo $data["ImagePath2"] ?>" />

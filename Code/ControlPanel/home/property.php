...
$_CUSTOM_CONTENT = "PROPERTY";
$_CUSTOM_CONTENT_NAME = "คุณสมบัติ";
$_CUSTOM_CONTENT_IMAGE_WIDTH = 100;
$_CUSTOM_CONTENT_IMAGE_HEIGHT = 100;
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-sm-4 col-lg-3">
                                                                <p>
                                                                    <div id="imge-preview-<?php echo $data["ImageCode"] ?>" class="image-box hand" onclick="$(this).next().click();" style="width: 100%; height: 200px;margin-bottom:5px; background-image: url(<?php echo $data["ImagePath"] ?>)">
                                                                    </div>

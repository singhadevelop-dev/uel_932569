...
$_CUSTOM_CONTENT = "FACILITY";
$_CUSTOM_CONTENT_NAME = "สิ่งอำนวยความสะดวก";
$_CUSTOM_CONTENT_IMAGE_WIDTH = 1920;
$_CUSTOM_CONTENT_IMAGE_HEIGHT = 1080;
...
if (isset($_POST["btnUpload"])) {
    ...
    $sqlInsert = "insert into gallery (SEQ,ImageCode,RefCode,ImagePath,Active,CreatedOn,CreatedBy)
    VALUES(
        '$num',
        '$imageCode',
        '$_CUSTOM_CONTENT',
                        ...
                        <div class="row" id="sortable">
                            ...
                            ?>
                                <div class="col-sm-4 col-lg-3 ui-state-item" data-image-code="<?php echo $data["ImageCode"] ?>">
                                    ...
                                    <div class="text-center hide" style="margin-bottom:20px">
                                        <b><?php echo empty($data["ImageDetail"]) ? "<i class='text-danger'>ไม่ได้ระบุรายละเอียด</i>" : $data["ImageDetail"] ?></b>
                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-sm-4 col-lg-3">
                                                                <p>
                                                                    <div id="imge-preview-<?php echo $data["ImageCode"] ?>" class="image-box hand" onclick="$(this).next().click();" style="width: 100%; height: 150px;margin-bottom:5px; background-image: url(<?php echo $data["ImagePath"] ?>)">
                                                                    </div>

...
if(isset($_POST["btnSave"])){
    ...
    ExecuteSQLTransaction($sql,"productColor.php");
}
...
<div class="mat-box grey-bar">
    ...
    /
    <a href="productColor.php" class="link-history-btn">รายการสี</a>
    /
    <span class="link-history-btn">จัดการข้อมูลสีของ<?php echo $_COG_ITEM_NAME ?></span>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="color" name="txtColorCode" id="txtColorCode" value="<?php echo $data["FreeText"] ?>" class="form-control input-sm require" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <a href="productColor.php" class="btn btn-danger">

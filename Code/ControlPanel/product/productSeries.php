...
<div class="mat-box grey-bar">
    ...
    /
    <span class="link-history-btn">รายการซีรีย์</span>
...
<div class="mat-box" style="border-radius: 0 0 3px 3px">
    <div class="row">
        <div class="col-md-3">
            <?php 
            $_LEFT_MENU_ACTIVE = "SERIES";
            include "leftMenu.php"; 
            ?>
        </div>
        <div class="col-md-9">
            <div>
                <a href="productSeriesDetail.php" class="pull-right">
                    <i class="fa fa-plus"></i>
                    เพิ่มรายการซีรีย์
                </a>
                <span><b>รายการซีรีย์</b></span>
            ...
            <table 
                ...
                <tbody>
                    ...
                    $sql = "select * from tag where TagType='SERIES' order by SEQ";

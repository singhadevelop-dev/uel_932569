...
<div class="mat-box grey-bar">
    ...
    /
    <span class="link-history-btn">แท็ก</span>
...
<div class="mat-box" style="border-radius: 0 0 3px 3px">
    <div class="row">
       <div class="col-md-2">
            <?php 
            $_LEFT_MENU_ACTIV = "TAG";
            include "leftMenu.php";
            ?>
        </div>
        <div class="col-md-10">
            <div>
                <a href="productTagDetail.php" class="pull-right">
            ...
            <table class="jquery-datatable display" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    $sql = "select * from tag where TagType = 'PRODUCT' order by TagCode";
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="productTagDetail.php?ref=<?php echo $data["TagCode"] ?>">
                                <i class="fa fa-cog"></i>
                            </a>

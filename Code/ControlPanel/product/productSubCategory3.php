...
if(isset($_POST["btnDeleteRow"])){
    $sql = "delete from product_sub_category3 where SubCategoryCode3 = '".$_POST["btnDeleteRow"]."'";
    ExecuteSQL($sql);
    
    $sql = "update product set SubCategoryCode3 = '' where SubCategoryCode3 = '".$_POST["btnDeleteRow"]."'";
    ExecuteSQL($sql);

    $sql = "update product_sub_category4 set SubCategoryCode3 = '' where SubCategoryCode3 = '".$_POST["btnDeleteRow"]."'";
    ExecuteSQL($sql);
}
...
<div class="mat-box grey-bar">
    ...
    /
    <span class="link-history-btn">รายการหมวดหมู่<?php echo $_COG_ITEM_NAME ?> ที่ 3</span>
...
<div class="mat-box" style="border-radius: 0 0 3px 3px">
    <div class="row">
       <div class="col-md-3">
            <?php 
            $_LEFT_MENU_ACTIVE = "SUBCATEGORY3";
            include "leftMenu.php"; 
            ?>
        </div>
        <div class="col-md-9">
            <div>
                <a href="productSubCategoryDetail3.php" class="pull-right">
                    <i class="fa fa-plus"></i>
                    เพิ่มรายการหมวดหมู่<?php echo $_COG_ITEM_NAME ?> ที่ 3
                </a>
                <span><b>รายการหมวดหมู่<?php echo $_COG_ITEM_NAME ?> ที่ 3</b></span>
            ...
            <table 
                ...
                <thead>
                    <tr>
                        ...
                        <th>ชื่อหมวดหมู่ย่อยที่ 3</th>
                        <th>ชื่อหมวดหมู่ย่อยที่ 2</th>
                        <th>หมวดหมู่</th>
                ...
                <tbody>
                    ...
                    ?>
                    <tr data-sortable-row-key="<?php echo $data["SubCategoryCode3"] ?>">
                        ...
                        <td class="text-center sortable-hide-item">
                            <a href="productSubCategoryDetail3.php?ref=<?php echo $data["SubCategoryCode3"] ?>">
                                <i class="fa fa-cog"></i>
                            </a>

...
if(isset($_POST["btnUpdateImage"])){
    $uploadFileTarget = "/ControlPanel/assets/images/productGallery/";
...
if(isset($_POST["btnUpload"])){
    ...
    $uploadFileTarget = $GLOBALS["ROOT"]."/_content_files/product_gallery_hi/";//"/ControlPanel/assets/images/productGallery/";
...
<div class="mat-box grey-bar">
    ...
    /
    <span class="link-history-btn">แกลเลอรี่<?php echo $_COG_ITEM_NAME ?> (แปลนบ้าน) (<?php echo $data["ProductCode"] ?>)</span>
        ...
        <div class="col-md-12">
            <div>
                <span><b>แกลเลอรี่<?php echo $_COG_ITEM_NAME ?>
                    <span class="text-orange"><?php echo $data["ProductName"] ?> (แปลนบ้าน) </span>
                      </b></span>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                         ...
                         <div class="row">
                            ...
                            $sql = "select * from gallery where RefCode = '".$refCode."_HI' order by ImageCode";
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8 col-lg-9 hide">
                                                            <p>

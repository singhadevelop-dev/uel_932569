...
if(isset($_POST["btnSave"])){
    ...
    ExecuteSQLTransaction($sql,"productStatus.php");
}

if(!empty($_GET["ref"]))
{
    $sql = "select * from tag where TagType='PRODUCT_STATUS' and TagCode = '".$_GET["ref"]."'";
    $data = SelectRow($sql);
}
?>
...
<div class="mat-box grey-bar">
    ...
    /
    <a href="productStatus.php" class="link-history-btn">รายการสถานะ</a>
    /
    <span class="link-history-btn">จัดการข้อมูลสถานะ</span>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <a href="productStatus.php" class="btn btn-danger">

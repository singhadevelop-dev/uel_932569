...
if(isset($_POST["btnDeleteRow"])){
    $sql = "update tag set Active=0 where TagType='PRODUCT_STATUS' and TagCode = '".$_POST["btnDeleteRow"]."'";
    ExecuteSQL($sql);
}
?>
...
<div class="mat-box grey-bar">
    ...
    /
    <span class="link-history-btn">รายการสถานะ</span>
...
<div class="mat-box" style="border-radius: 0 0 3px 3px">
    <div class="row">
        <div class="col-md-3">
            <?php 
            $_LEFT_MENU_ACTIVE = "STATUS";
            include "leftMenu.php"; 
            ?>
        </div>
        <div class="col-md-9">
            <div>
                <a href="productStatusDetail.php" class="pull-right">
                    <i class="fa fa-plus"></i>
                    เพิ่มรายการสถานะ
                </a>
                <span><b>รายการสถานะ</b></span>
            ...
            <table 
                ...
                <tbody>
                    ...
                    $sql = "select * from tag where TagType='PRODUCT_STATUS' and Active=1 order by SEQ";

...
if(isset($_POST["btnSave"])){
    ...
    ExecuteSQLTransaction($sql,"productSeries.php");
}

if(!empty($_GET["ref"]))
{
    $sql = "select * from tag where TagType='SERIES' and TagCode = '".$_GET["ref"]."'";
    $data = SelectRow($sql);
}
?>
...
<div class="mat-box grey-bar">
    ...
    /
    <a href="productSeries.php" class="link-history-btn">รายการซีรีย์</a>
    /
    <span class="link-history-btn">จัดการข้อมูลซีรีย์</span>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <a href="productSeries.php" class="btn btn-danger">

...
<div class="mat-box grey-bar">
    ...
    /
    <span class="link-history-btn">แกลเลอรี่<?php echo $_COG_ITEM_NAME ?> (EXTERIOR) (<?php echo $data["ProductCode"] ?>)</span>
    ...
    <div class="row">
        <div class="col-md-2">
            <div>
                ...
                <a class="left-group" data-det-group="NTERIOR" href="productDetailGallery.php?ref=<?php echo $refCode  ?>">INTERIOR <i class="fa fa-caret-right pull-right"></i></a>
                <a class="left-group active" data-det-group="EXTERIOR" href="productDetailGallery2.php?ref=<?php echo $refCode  ?>">EXTERIOR<i class="fa fa-caret-right pull-right"></i></a>
            </div>
        </div>
        <div class="col-md-10">
            <div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                         ...
                         <div class="row">
                            ...
                            $sql = "select * from gallery where RefCode = '".$refCode."_EX' order by ImageCode";
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-sm-4 col-lg-4">
                                                            ...
                                                            style="width: 100%; height: 180px;margin-bottom:5px; background-image: url(<?php echo $data["ImagePath"] ?>), url('https://ipsumimage.appspot.com/800x800,eee')">
                                                                </div>
                            ...
                            <div class="col-sm-4 col-lg-4">
                                <form method="post" enctype="multipart/form-data">
                                    <div class="slide-banner image-box slide-adder hand" onclick="$(this).next().click();" style="position: relative; background-image: url('https://ipsumimage.appspot.com/800x800,eee');">
                        ...
                        <div class="panel-footer">
                            <b class="text-danger">
                                <small>*ขนาดภาพที่เหมาะสมที่สุดคือ 800 x 800 pixels</small>
                            </b>
                        </div>
                    </div>
                    <script>

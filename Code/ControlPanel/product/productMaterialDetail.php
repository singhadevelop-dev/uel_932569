...
if(isset($_POST["btnSave"])){
    ...
    ExecuteSQLTransaction($sql,"productMaterial.php");
}

if(!empty($_GET["ref"]))
{
    $sql = "select * from tag where TagType='MATERIAL' and TagCode = '".$_GET["ref"]."'";
    $data = SelectRow($sql);
}
?>
...
<div class="mat-box grey-bar">
    ...
    /
    <a href="productMaterial.php" class="link-history-btn">รายการ Material</a>
    /
    <span class="link-history-btn">จัดการข้อมูล Material</span>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <a href="productMaterial.php" class="btn btn-danger">

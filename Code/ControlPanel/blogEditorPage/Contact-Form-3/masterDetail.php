...
if (isset($_POST["btnSave"])) {
    ...
    if ($dataOld !== false) {
        ...
        $sqlUpdate = "insert into portfolio (PortCode,PortName,PortDetail,PortHtml2,Image,Image2,Image3,Video,FileDownload,FileDownloadName,Active,CreatedOn,CreatedBy,PortType,ShortDescription,PortDetail1,Year,ByName,Status,Fax,Mobile,Email,Phone,Address)
            VALUES(
                '$portCode',
                '$txtSubject',
                '$txtDetail',
...
<div class="mat-box grey-bar">
    <a href="<?php echo $_COG_ALLOW_LEFT_MENU_ITEMS ? "item.php" : "masterDetail.php"  ?>"
        class="link-history-btn">หน้าหลัก<?php echo $_COG_ITEM_NAME ?></a>
        ...
        <div class="col-md-<?php echo $_COG_ALLOW_LEFT_MENU ? "10" : "12" ?>">
            <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <div>
                                            ...
                                            <div class="row panel-video">
                                                ...
                                                <div
                                                    class="panel-video-display col-xs-12 <?php echo !empty($data["Video"]) ? "" : "hide" ?>">
                                                    <div class="slide-banner image-box">
                                                        <iframe class="iframe-video-diaplay"
                                                            style="width:100%;height:100%;background:#000"
                                                            src="<?php echo $data["Video"] ?>"></iframe>
                                                        <i class="fa fa-trash remover"
                                                            onclick="$(this).next().click();"></i>
                                                        <input type="button" onclick="confirmDeleteVedio(this);"
                                                            class="btn-delete hide" name="btnDelete" value="" />
                                                        <input type="hidden" name="hddFilePathVedio"
                                                            value="<?php echo $data["Video"] ?>" />
                                                    </div>
                                                </div>

                                                <div
                                                    class="panel-video-add col-xs-12 <?php echo empty($data["Video"]) ? "" : "hide" ?>">

                                                    <div class="slide-banner image-box slide-adder hand"
                                                        onclick="openModalInsert();"
                                                        style="position: relative; background-color: #eee;">
                                                        <div
                                                            style="position: absolute; left: 0; right: 0; top: 75px; text-align: center;">
                                                            <i class="fa fa-video fa-5x text-muted"></i>
                                                        </div>
                                                        <div
                                                            style="position: absolute; left: 0; right: 0; bottom: 150px; text-align: center;">
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p>
                                                                <img src="../../video/assets/how-1.png"
                                                                    style="width:100%" />
                                                            </p>
                                                            <p>
                                                            ...
                                                            <p>
                                                                <img src="../../video/assets/how-2.png"
                                                                    style="width:100%" />
                                                            </p>
                                                        </div>
                                            ...
                                            <script>
                                                ...
                                                function onchangeVideoInsert(obj) {
                                                    ...
                                                    if (val.toLowerCase().match("youtube.com") && val.toLowerCase().match(
                                                            "v=")) {
                                                        val = "https://www.youtube.com/embed/" + getUrlVars(val)[
                                                            "v"]; //val.split("v=")[val.split("v=").length - 1];
                                                    } else if (val.toLowerCase().match("youtu.be")) {
                                                        val = "https://www.youtube.com/embed/" + val.split("/")[val.split("/")
                                                            .length - 1];
                                                    }
                                                    $(obj).prev().val(val);
                                                ...
                                                function onchangeVideoDiaplayForSave(obj) {
                                                    if ($("[name='txtImagePathVideo']").val().trim() != "") {
                                                        var val = $(obj).closest('.modal-dialog').find(
                                                            "[name='txtImagePathVideo']").val();
                                                        if (val.toLowerCase().match("youtube.com") && val.toLowerCase().match(
                                                                "v=")) {
                                                            val = "https://www.youtube.com/embed/" + getUrlVars(val)[
                                                        ...
                                                        $(frame).closest('.slide-banner').find('[name="hddFilePathVedio"]').val(
                                                            val);
                                                        frame.prop("src", val);
                                            ...
                                            <div id="modal-insert" class="modal fade" role="dialog">
                                                <div class="modal-dialog  modal-lg">
                                                    ...
                                                    <div class="modal-content">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <p>
                                                                        ...
                                                                        <iframe class="iframe-video"
                                                                            style="width:100%;height:280px;background:#000"></iframe>
                                                                    </p>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <p>
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text" placeholder="URL Youtube"
                                                                            class="form-control input-sm require"
                                                                            name="txtImagePathVideo"
                                                                            value="<?php echo $data["Video"] ?>" />
                                                                        <span class="input-group-addon hand"
                                                                            onclick="onchangeVideoInsert(this);">
                                                                    ...
                                                                    <p>
                                                                        <b class="text-danger">
                                                                            ** เมื่อกรอก URL แล้วกดปุ่ม <i
                                                                                class="fa fa-refresh"></i> หาก URL
                                                                            ถูกต้องวีดีโอของคุณจะปรากฏในด้านซ้าย
                                                                        </b>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <span onclick="onchangeVideoDiaplayForSave(this);"
                                                                class="btn btn-success">บันทึก</span>
                    ...
                    <?php if ($_COG_ALLOW_MASTER_VIDEO2) { ?>
                        <div class="col-md-6">
                            ...
                            <div class="row panel-video">
                                ...
                                <div
                                    class="panel-video-display col-xs-12 <?php echo !empty($data["Video2"]) ? "" : "hide" ?>">
                                    <div class="slide-banner image-box">
                                        <style>
                                            .slide-banner {
                                                width: 100%;
                                        ...
                                        <video class="slide-banner video-local-server" controls="" muted=""
                                            style="object-fit:cover;border-radius: 5px;">
                                            <source src="<?php echo $data["Video2"] ?>">
                                        </video>
                                        <i class="fa fa-pencil editer <?php echo !empty($data["Video2"]) ? "" : "hide" ?>"
                                            onclick="$(this).closest('.panel-video').find('input[type=file]').click();"></i>
                                        <i class="fa fa-remove remover <?php echo !empty($data["Video2"]) ? "" : "hide" ?>"
                                            onclick="deleteVideoLocal(this);"></i>
                                ...
                                <div class="panel-video-add col-xs-12 <?php echo empty($data["Video2"]) ? "" : "hide" ?>">
                                    <div class="slide-banner image-box slide-adder hand"
                                        onclick="$(this).closest('.panel-video').find('input[type=file]').click();"
                                        style="position: relative; background-color: #eee;">
                                ...
                                <input class="hide" type="file" onchange="uploadBannerVideo(this);" name="fileUploadVideo"
                                    accept="video/*" />
                    ...
                    <?php if ($_COG_ALLOW_MASTER_GALLERY) { ?>
                        <div class="col-md-6">
                            <div>
                                ...
                                <img id="imge-preview" class="slide-banner"
                                    style="object-fit: cover;height: 300px;width: 100%;background-color: #eee;"
                    ...
                    <?php if ($_COG_ALLOW_MASTER_GALLERY2) { ?>
                        <div class="col-md-6">
                            <div>
                                ...
                                <hr style="margin-top: 5px; margin-bottom: 5px;" />
                                <img id="imge-preview2" class="slide-banner"
                    ...
                    <?php if ($_COG_ALLOW_MASTER_GALLERY3) { ?>
                        <div class="col-md-6">
                            <div>
                                <span><b>รูปภาพรอง<?php echo $_COG_ITEM_NAME ?></b></span>
                                <hr style="margin-top: 5px; margin-bottom: 5px;" />
                                <img id="imge-preview3" class="slide-banner"
                                    style="object-fit: cover;height: 300px;width: 100%;"
                ...
                <?php if ($_COG_ALLOW_MASTER_TITLE || $_COG_ALLOW_MASTER_YEAR) { ?>
                    <div class="row">
                        <?php if ($_COG_ALLOW_MASTER_TITLE) { ?>
                            <div class="col-sm-<?php echo $_COG_ALLOW_MASTER_YEAR ? "6" : "10" ?>">
                                <label>หัวข้อ<?php echo $_COG_ITEM_NAME ?></label>
                                <!-- <input type="text" placeholder="หัวข้อ<?php //echo $_COG_ITEM_NAME 
                                                                            ?>..." name="txtSubject" id="txtSubject" value="<?php //echo $data["PortName"] 
                                                                                                                            ?>" class="form-control input-sm require" /> -->
                                <textarea placeholder="หัวข้อ<?php echo $_COG_ITEM_NAME ?>..." name="txtSubject" id="txtSubject"
                                    class="form-control input-sm require"><?php echo $data["PortName"] ?></textarea>
                            </div>
                        <?php } ?>
                        <?php if ($_COG_ALLOW_MASTER_YEAR) { ?>
                            <div class="col-sm-6">
                                <label>หัวข้อ (บนเบอร์โทร)</label>
                                <input type="text" placeholder="หัวข้อ (บนเบอร์โทร)..." name="txtYear" id="txtYear"
                                    value="<?php echo $data["Year"] ?>" class="form-control input-sm require" />
                            </div>
                        <?php } ?>
                    </div>
                <?php } ?>
                <?php if ($_COG_ALLOW_MASTER_AUTHOR) { ?>
                    <div class="row">
                        <div class="col-sm-12">
                            <label>หัวข้อ (บนแบบฟอร์ม)</label>
                            <input type="text" placeholder="หัวข้อ (บนแบบฟอร์ม)..." name="txtByName" id="txtByName"
                                value="<?php echo $data["ByName"] ?>" class="form-control input-sm require" />
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php if ($_COG_ALLOW_MASTER_SHORT_DESCRIPTION) { ?>
                    <div class="row">
                        <div class="col-sm-10">
                            ...
                            <textarea name="txtShortDescription" id="txtShortDescription"
                                class="form-control input-sm area-box-fix shortdescription-box require"><?php echo $data["ShortDescription"] ?></textarea>
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div>
                                ...
                                <hr style="margin-top: 5px; margin-bottom: 5px;" />
                                <input type="file" name="txtFileUpload" value=""
                                    onchange="validateUploadFileUpload(this);" />
                                <script>
                                ...
                                <?php } ?>
                                <input type="hidden" name="hddBackUpFileDownload"
                                    value="<?php echo $data["FileDownload"] ?>" />
                                <input type="hidden" name="hddBackUpFileDownloadName"
                                    value="<?php echo $data["FileDownloadName"] ?>">
                            </div>
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" name="txtLatLng"
                                placeholder="https://www.google.co.th/maps/" value="<?php echo $data["MapLocation"] ?>" />
                            <?php
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" placeholder="Name..." name="txtName" id="txtName"
                            value="<?php echo  $data["Status"] ?>" class="form-control input-sm" />
                    </div>
                    <div class="col-sm-4">
                        <label>Company Name</label>
                        <input type="text" placeholder="Company Name..." name="txtCompany" id="txtCompany"
                            value="<?php echo  $data["Fax"] ?>" class="form-control input-sm" />
                    </div>
                    <div class="col-sm-4">
                        <label>Subject</label>
                        <input type="text" placeholder="Subject..." name="txtSubject2" id="txtSubject2"
                            value="<?php echo  $data["Mobile"] ?>" class="form-control input-sm" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" placeholder="Email..." name="txtEmail" id="txtEmail"
                            value="<?php echo  $data["Email"] ?>" class="form-control input-sm" />
                    </div>
                    <div class="col-sm-4">
                        <label>Phone</label>
                        <input type="text" placeholder="Phone..." name="txtPhone" id="txtPhone"
                            value="<?php echo  $data["Phone"] ?>" class="form-control input-sm" />
                    </div>
                    <div class="col-sm-4">
                        <label>Message</label>
                        <input type="text" placeholder="Message..." name="txtMessage" id="txtMessage"
                            value="<?php echo  $data["Address"] ?>" class="form-control input-sm" />
                    </div>
                </div>
                ...
                <?php if ($_COG_ALLOW_MASTER_LINK) { ?>
                    <div class="row">
                        <div class="col-sm-10">
                            ...
                            <input type="text" placeholder="ชื่อปุ๋ม..." name="txtLinkWeb" id="txtLinkWeb"
                                value="<?php echo  $data["PortDetail1"] ?>" class="form-control input-sm" />
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php if ($_COG_ALLOW_MASTER_ACTIVE) { ?>
                    <div>
                        ...
                        <div>
                            <i id="toggle-active" class="fa fa-toggle-on fa-3x text-success hand" style=""
                                onclick="toggleActive(this);"></i>

...
if(isset($_POST["btnSubmit"])){
    ...
    $txtDetail4 = $_COG_ALLOW_HTML_EDITOR4 ? GeneratePageFile($_POST["txtDetailHTML4"],$_COG_ITEM_CODE."-".$portCode."4") : "";
    ...
    $uploadFileTarget2 =  $GLOBALS["ROOT"]."/_content_images/".strtolower($_COG_ITEM_CODE)."/image2/";
    $uploadFileTarget3 = $GLOBALS["ROOT"]."/_content_images/".strtolower($_COG_ITEM_CODE)."/image3/";
    $uploadFileTargetDetail =  $GLOBALS["ROOT"]."/_content_images/".strtolower($_COG_ITEM_CODE)."/fileupload/";
    $uploadFileTargetDetail2 =  $GLOBALS["ROOT"]."/_content_images/".strtolower($_COG_ITEM_CODE)."/fileupload2/";
    ...
    $allItemSelected2 = "";
    $chkItemSelected2 = $_POST["chkItemSelected2"];
    for ($i = 0; $i < count($chkItemSelected2); $i++)
    {
        $select2 = $chkItemSelected2[$i];
        if(isset($select2)){
    	    if(!empty($allItemSelected2)){
                $allItemSelected2 .=",";
            }
            $allItemSelected2 .= $select2;
        }
    }
    ...
    if($_Is_EditMode)
    {
        $sqlUpdate = "update portfolio set 
                    ...
                    ,ItemSelected2='$allItemSelected2'
                    ,Active = '$chkActive'
                    ,UpdatedOn = NOW()
    ...
    {
        $sqlInsert = "insert into portfolio (PortCode,PortRefCode,PortName,ShortDescription,PortDetail,PortHtml2,PortHtml3,PortHtml4,Image,Image2,Image3,ImageIcon,Video,Video2,FileDownload,FileDownloadName,FileDownload2,FileDownloadName2,ByName,Client,Title,
                        Description,Keyword,Tag,ItemSelected,ItemSelected2,Active,CreatedOn,CreatedBy,PortType,CategoryCode,SubCategoryCode,PortDetail1,PortDetail2,
                        Email,Phone,Mobile,Fax,Address,MapLocation,Facebook,IG,Twitter,Youtube,Googleplus,Whatsapp,Linkedin,LineID,PortDateTime,New,Year,Hour,Project,Status,Amount,Rank,ProvinceCode,RoadCode,Color)
                    VALUES(
                        '$portCode',
                        '$txtRefCode',
                        '$txtSubject',
    ...
    if($_COG_ITEM_PROPERTIES){
        ...
        for ($i = 0; $i < count($txtPropName); $i++){
            $propCode = str_pad(($i+1),3,'0',STR_PAD_LEFT);
            $propName = trim($txtPropName[$i]);
            $propDetail = trim($txtPropDetail[$i]);
        $sqlInsertColor = "insert into portfolio_properties (PropCode,PortCode,Name,Detail)
                                    values(
                                    '$propCode',
                                    '$portCode',
                                    '$propName',
...
<div class="mat-box" style="border-radius: 0 0 3px 3px">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="<?php echo $_COG_ALLOW_TEXT_FULL_PAGE ? "col-md-12" : "col-md-9"  ?>">
                        ...
                        <?php if($_COG_ALLOW_HTML_PHONE || $_COG_ALLOW_HTML_MOBILE){ ?>
                            <div class="row">
                                <?php if($_COG_ALLOW_HTML_PHONE){ ?>
                                <div class="col-sm-<?php echo $_COG_ALLOW_HTML_MOBILE ? "6" : "12" ?>">
                                ...
                                <?php } ?>
                                <?php if($_COG_ALLOW_HTML_MOBILE){ ?>
                                <div class="col-sm-<?php echo $_COG_ALLOW_HTML_PHONE ? "6" : "12" ?>">
                                    <label>เบอร์มือถือ</label>
                                    <input type="text" placeholder="เบอร์มือถือ..." name="txtMobile" id="txtMobile" value="<?php echo  $data["Mobile"] ?>" class="form-control input-sm require" />
                                </div>
                                <?php } ?>
                            </div>
                        <?php } ?>
                        ...
                        <?php if($_COG_ALLOW_HTML_FAX || $_COG_ALLOW_HTML_EMAIL){ ?>
                            <div class="row">
                                <?php if($_COG_ALLOW_HTML_FAX){ ?>
                                <div class="col-sm-<?php echo $_COG_ALLOW_HTML_EMAIL ? "6" : "12" ?>">
                                    <label>แฟ็กซ์</label>
                                ...
                                <?php if($_COG_ALLOW_HTML_EMAIL){ ?>
                                    <div class="col-sm-<?php echo $_COG_ALLOW_HTML_FAX ? "6" : "12" ?>">
                                        <label>อีเมลล์</label>
                        ...
                        <?php if($_COG_REF_SELECT_ITEM){ ?>
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <?php
                                        $sqlitem = "select PortCode,PortName,Image,ImageIcon FROM portfolio WHERE Active=1 and PortType='$_COG_REF_SELECT_ITEM_CODE' order by SEQ,PortCode ";
                                        ...
                                        <div class="col-sm-6" onclick="$(this).find('input').click();">
                                            ...
                                            <?php } ?>
                                            <label onclick="event.stopPropagation();" for="chk-<?php echo $item["PortCode"] ?>" class="hand"> <?php echo !empty($_COG_REF_SELECT_ITEM_ICON) ? '<i class="fa '.$item["ImageIcon"].' text-primary" aria-hidden="true"></i>' : "" ?> <?php echo $item["PortName"] ?></label>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <?php if($_COG_REF_SELECT_ITEM2){ ?>
                            ...
                            <div>
                                ...
                                <span><b><?php echo $_COG_REF_SELECT_ITEM_TITLE2 ?></b></span>
                                <hr style="margin-top: 5px; margin-bottom: 10px;" />
                                <div class="row">
                                    <?php
                                        $sqlitem = "select PortCode,PortName,Image,ImageIcon FROM portfolio WHERE Active=1 and PortType='$_COG_REF_SELECT_ITEM_CODE2' order by SEQ,PortCode ";
                                        $dataItem = SelectRowsArray($sqlitem);
                                        foreach ($dataItem  as $item) {
                                        ?>
                                        <div class="col-sm-6" onclick="$(this).find('input').click();">
                                            <input onclick="event.stopPropagation();" class="chk-itemselected" type="checkbox" <?php echo strpos($data["ItemSelected2"],$item["PortCode"]) !== false ? "checked" : "" ?> name="chkItemSelected2[]" id="chk-<?php echo $item["PortCode"] ?>-2" value="<?php echo $item["PortCode"] ?>" />
                                            <?php if($_COG_REF_SELECT_ITEM_IMAGE2){ ?>
                                                &nbsp;<img src="<?php echo $item["Image"] ?>" alt="item-<?php echo $item["PortCode"] ?>" class="img-selected">
                                            <?php } ?>
                                            <label onclick="event.stopPropagation();" for="chk-<?php echo $item["PortCode"] ?>-2" class="hand"> <?php echo !empty($_COG_REF_SELECT_ITEM_ICON2) ? '<i class="fa '.$item["ImageIcon"].' text-primary" aria-hidden="true"></i>' : "" ?> <?php echo $item["PortName"] ?></label>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <?php if($_COG_ALLOW_SOCIAL_MEDIA){ ?>
                            ...
                            <div class="panel-social-media">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>Line ID</label>
                                        <input type="text" placeholder="LineID..." name="txtLineID" id="txtLineID"
                                            value="<?php echo $data["LineID"] ?>" class="form-control input-sm" />
                                    </div>
                                    ...
                                    <h3>ข้อมูลและคุณสมบัติ
                                        ...
                                        <div>
                                            <table class="table table-striped">
                                                ...
                                                ?>
                                                <tr>
                                                    <th class="text-right" style="width: 200px; vertical-align: middle; padding-right: 30px; color: #ed2437"><?php echo $dataProp["PropName"] ?><?php if($_COG_PROPERTIES_ICON){ ?>&nbsp;&nbsp;<i class="fa <?php echo $dataProp["PropIcon"] ?>"></i><?php } ?></th>
                        ...
                        <?php if($_COG_ALLOW_COLOR){ ?>
                            <div class="product-color-container">
                                ...
                                <div class="row">
                                <?php
                                $sqlTags = "select * from tag where TagType = 'COLOR-$_COG_ITEM_CODE ' and Active = 1 order by TagCode";
                                $dataTags = SelectRows($sqlTags);
                                foreach ($dataTags as $tag) {
                                ?>
                                <div class="col-sm-6" onclick="$(this).find('input').click();">
                                    <input onclick="event.stopPropagation();" class="chk-tag" type="checkbox" <?php echo strpos($data["Color"],$tag["TagCode"]) !== false ? "checked" : "" ?> name="chkColor[]" id="chk-<?php echo $tag["TagCode"] ?>" value="<?php echo $tag["TagCode"] ?>" />
                    ...
                    <?php if($_COG_ALLOW_MAIN_IMAGE){ ?>
                        <div>
                            ...
                            <img id="imge-preview" data-size="<?php echo $image_size ?>" style="background-color: #eae8e8;" src="<?php echo empty($data["Image"]) ? (empty($_COG_ALLOW_MAIN_IMAGE_SIZE) || $_COG_ALLOW_MAIN_IMAGE_SIZE == "1200x900" ? "../../assets/images/default/1200x900.png" : "../../assets/images/default/$image_size.png") : $data["Image"] ?>" 
                            class="img-responsive hand" onclick="$(this).next().click();"/>
                    ...
                    <?php } if($_COG_ALLOW_HTML_LOGO){ ?>
                        ...
                        <div>
                            ...
                            <img id="imge-preview-2" style="background-color: #eae8e8;" src="<?php echo empty($data["Image2"]) ? "../../assets/images/default/1200x900.png" : $data["Image2"] ?>" 
                            class="img-responsive hand" onclick="$(this).next().click();"/>
                ...
                <?php if($_COG_ITEM_PROPERTIES){ ?>
                <div class="alert alert-success">
                    <h4 style="margin-bottom:10px"><b><?php echo !empty($_COG_ITEM_PROPERTIES_TITLE) ? $_COG_ITEM_PROPERTIES_TITLE : "ข้อมูลเฉพาะ" ?></b></h4>
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-striped" style="background: #fff">
                                ...
                                <tbody>
                                    <?php
                                        $sqlPropUnique = "select * from portfolio_properties where PortCode='".$data["PortCode"]."' order by PropCode asc ";
                                        $datasProps = SelectRowsArray($sqlPropUnique);
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            <textarea name="txtPropDetailUni[]" rows="3" placeholder="คำอธิบาย..." class="form-control input-sm require"><?php echo $propQ["Detail"] ?></textarea>
                                        </td>
                                    ...
                                    <?php } ?>
                                    <?php if(count($datasProps) <= 0 && empty($data["PortCode"])){ ?>
                                        <tr>
                                            <th>
                                                <label class="hide">หัวข้อ</label>
                ...
                <?php if($_COG_ALLOW_HTML_EDITOR4){ ?>
                    <hr />
                    <div class="row">
                        <div class="col-sm-12 summernote-container">
                            ...
                            <?php 
                            // =============== HTML EDITOR =============== 
                            $_HTML_EDITOR_NAME = "txtDetailHTML4";
                            $_HTML_EDITOR_CONTENT_ID = $data["PortHtml4"];
                            include $GLOBALS['DOCUMENT_ROOT'].'/ControlPanel/HtmlEditor/HtmlEditor.php'; 
                            ?>
                        </div>
                    </div>
    ...
    <table class="hide">
        <tr class="tmp">
            ...
            <td class="">
                <label class="hide">คำอธิบาย</label>
                <textarea name="txtPropDetailUni[]" rows="3" placeholder="คำอธิบาย..." class="form-control input-sm require"></textarea>        
            </td>
            <td class="text-center">
                <a href="javascript:;" onclick="$(this).closest('tr').remove();">
                    <i class="fa fa-trash"></i>

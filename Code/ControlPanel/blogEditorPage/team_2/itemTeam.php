...
<?php //include_once  "../_master/_master_team.php"; ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row"  id="sortable">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-sm-4 col-lg-3">
                                                                ...
                                                                style="width: 100%; height: 250px;margin-bottom:5px; background-image: url(<?php echo $data["Image"] ?>), url('https://dummyimage.com/600x600')">
                                                                    </div>
                                                            ...
                                                            <div class="col-sm-8 col-lg-9">
                                                                ...
                                                                <p class="">
                                                                    <label>ตำแหน่ง</label>
                                                                    <input type="text" class="form-control input-sm require" name="txtTeamPosition" value="<?php echo $data["Position"] ?>" />
                                                                </p>
                                                                <p class="hide">
                                                                    <label>Email</label>
                                                                    <input type="email" class="form-control input-sm require" name="txtTeamEmail" value="<?php echo $data["Email"] ?>" placeholder="example@email.com" />
                                                                </p>
                                                                <p class="hide">
                                                                    <label>Phone</label>
                                                                    <input type="text" class="form-control input-sm require" name="txtTeamPhone" value="<?php echo $data["Phone"] ?>" />
                                                                </p>
                                                                <br>
                                                                <style>
                                ...
                                <div class="col-sm-4 col-lg-3">
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="slide-banner image-box slide-adder hand" onclick="$(this).next().click();" style="position: relative; background-image: url('https://dummyimage.com/600x600');">
                            ...
                            <div class="panel-footer">
                                ...
                                <b class="text-danger">
                                    <small>*ขนาดภาพที่เหมาะสมที่สุดคือ 600 x 600 pixels</small>
                                </b>
                            </div>
                        </div>
                        <script>

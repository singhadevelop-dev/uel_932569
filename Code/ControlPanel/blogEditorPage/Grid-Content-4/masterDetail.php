        ...
        <div class="col-md-<?php echo $_COG_ALLOW_LEFT_MENU ? "10" : "12" ?>">
            <form method="post" enctype="multipart/form-data">
                ...
                <?php if($_COG_ALLOW_MASTER_AUTHOR){ ?>
                    <div class="row">
                        <div class="col-sm-12">
                            <label>หัวข้อ 2</label>
                            <input type="text" placeholder="หัวข้อ 2..." name="txtByName" id="txtByName" value="<?php echo $data["ByName"] ?>" class="form-control input-sm require" />
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php if($_COG_ALLOW_MASTER_LINK){ ?>
                    <div class="row">
                        <div class="col-sm-10">
                            <label>รายละเอียดแบบย่อ 2</label>
                            <textarea type="textarea" placeholder="รายละเอียดแบบย่อ 2..." name="txtLinkWeb" id="txtLinkWeb" class="form-control input-sm area-box-fix shortdescription-box require"><?php echo $data["PortDetail1"] ?></textarea>
                        </div>
                    </div>
                <?php } ?>

                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8 col-lg-9">
                                                                ...
                                                                <p class="">
                                                                    <label>Email</label>
                                                                    <input type="email" class="form-control input-sm require" name="txtTeamEmail" value="<?php echo $data["Email"] ?>" placeholder="example@email.com" required />
                                                                </p>
                                                                <p class="">
                                                                    <label>Phone</label>
                                                                    <input type="text" class="form-control input-sm require" name="txtTeamPhone" value="<?php echo $data["Phone"] ?>" required />
                                                                </p>
                                                                <br>
                                                                <style>

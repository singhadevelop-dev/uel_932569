...
if(isset($_POST["btnSave"])){
    ...
    $uploadFileTarget = $GLOBALS["ROOT"]."/_content_files/item_subcategory/";
    ...
    if(empty($_GET["ref"])){
        ...
        $sql = "insert into product_sub_category (SubCategoryCode,SubCategoryName,SubCategoryDetail,Image,ImageIcon,Active,CreatedOn,CreatedBy,CategoryCode) values(
                '$genID'
                ,'$txtSubject'
                ,'$txtDetail'
                ,'$fileUploadedPath'
    ...
    ExecuteSQLTransaction($sql,"itemSubCategory.php");
}
...
<div class="mat-box grey-bar">
    ...
    /
    <a href="itemSubCategory.php" class="link-history-btn">รายการหมวดหมู่<?php echo $_COG_ITEM_NAME ?>ย่อย</a>
    /
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="ddlBrand" class="form-control input-sm require">
                                    <?php echo GetDropDownListOptionWithDefaultSelectedAndCondition("product_category","CategoryCode","CategoryName","กรุณาเลือก",$data["CategoryCode"],"Active = 1 and CategoryGroup='$_COG_ITEM_CODE' ") ?>
                                </select>
                            </div>
                        </div>

                        <?php if($_COG_CATEGOTY_SUB_DETAIL){ ?>
                        <div class="row">
                            <div class="col-sm-12">
                    ...
                    <div class="col-md-3">
                        <?php if($_COG_CATEGOTY_SUB_MAIN_IMAGE){ ?>
                            <div>
                                <span><b>รูปภาพหลัก</b></span>
                                <hr style="margin-top: 5px; margin-bottom: 5px;" />
                                <p>
                                    <small class="text-danger">*ขนาดภาพที่เหมาะสมที่สุดคือ 600 x 700 pixels</small>
                                </p>

                                <img id="imge-preview" src="<?php echo empty($data["Image"]) ? "https://ipsumimage.appspot.com/600x700,eee" : $data["Image"] ?>" 
                        ...
                        <?php } ?>
                        <?php if($_COG_CATEGOTY_SUB_ICON){ ?>
                            <?php echo $_COG_CATEGOTY_SUB_MAIN_IMAGE ? "<br>" : "" ?> 
                            <div>

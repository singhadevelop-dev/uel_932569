...
if(isset($_POST["btnSubmit"])){
    ...
    else
    {
        $sqlInsert = "insert into portfolio (PortCode,PortRefCode,PortName,ShortDescription,PortDetail,PortHtml2,PortHtml3,Image,Image2,Image3,ImageIcon,Video,Video2,FileDownload,FileDownloadName,FileDownload2,FileDownloadName2,ByName,Client,Title,
                        ...
                        Email,Phone,Fax,Address,MapLocation,Facebook,IG,Twitter,Youtube,Googleplus,Whatsapp,Linkedin,PortDateTime,New,Year,Hour,Project,Status,Amount,Rank,ProvinceCode,RoadCode)
                    VALUES(
                        '$portCode',
                        '$txtRefCode',
                        '$txtSubject',
                        ...
                        <?php if($_COG_ALLOW_HTML_PHONE){ ?>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" placeholder="เบอร์โทร..." name="txtTelephone" id="txtTelephone" value="<?php echo  $data["Phone"] ?>" class="form-control input-sm">
                                </div>
                            </div>
                        <?php } ?>
                        <?php if($_COG_ALLOW_HTML_FAX){ ?>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" placeholder="แฟ็กซ์..." name="txtFax" id="txtFax" value="<?php echo  $data["Fax"] ?>" class="form-control input-sm" />
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if($_COG_ALLOW_HTML_ADDRESS){ ?>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="txtAddress" id="txtAddress" class="form-control input-sm"><?php echo $data["Address"] ?></textarea>
                                </div>
                            </div>
                        <?php } ?>

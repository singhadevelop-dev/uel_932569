                        ...
                        .done(function(msg) {
                            if (msg.length) {
                                ...
                                if (getdata.error) {
                                    ...
                                    var downloadlinks = '<button class="btn btn-default svgtopng" data-path="'+filepath+'">'+pngIcon+'</button><a href="#" class="btn btn-default hide preload-png">'+loadIcon+'</a><a class="serve-png hide" href="'+filepath+'.png" download="'+getdata.basename+'.png" data-path="'+filepath+'">PNG</a>';

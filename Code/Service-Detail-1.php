...
<body class="defult-home">
	...
	<div class="main-content">
		...
		<div class="rs-services-single pt-80 pb-80 sm-pt-40 sm-pb-40">
			<div class="container-xl">
				<div class="row">
					<div class="col-lg-8 md-mb-50">
						<!-- Slider Section Start -->
						<div class="rs-slider case-slider-style3">
						...
						<!-- Slider Section End -->
						<div class="services-title pb-20 pt-30">
							<h2 class="title"><?php echo $data["PortName"] ?></h2>
						</div>
					...
					<div class="col-lg-4 pl-36 md-pl-15">
						<ul class="services-list mb-50">
							<?php
							$relsuts = DataService::getInstance()->GetPortfolio("SERVICE");
							foreach ($relsuts as $items) {
							...
							?>
								<li>
									<a class="<?php echo $_GET["ref"] == $items["PortCode"] ? "active" : "" ?>" href="<?php echo $_URL ?>"><?php echo $items["PortName"]; ?></a>
								</li>
							<?php } ?>
						</ul>
